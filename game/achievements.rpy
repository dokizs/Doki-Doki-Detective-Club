...
define startgame = Achievement(
  name=_("Thanks for playing!"),
  id="playedthegame", # Used for Steam backend!
  description=_("We really appreciate you checking out our mod!"),
  unlocked_image="gui/logo.png"
)
